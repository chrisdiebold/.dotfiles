...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    ...
    loaded = true,
    path = "/Users/chris/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  ["feline.nvim"] = {
    loaded = true,
    path = "/Users/chris/.local/share/nvim/site/pack/packer/start/feline.nvim",
  ...
  ["monokai.nvim"] = {
    loaded = true,
    path = "/Users/chris/.local/share/nvim/site/pack/packer/start/monokai.nvim",
  ...
  ["rose-pine"] = {
    loaded = true,
    path = "/Users/chris/.local/share/nvim/site/pack/packer/start/rose-pine",
  ...
  ["vista.vim"] = {
    loaded = true,
    path = "/Users/chris/.local/share/nvim/site/pack/packer/start/vista.vim",
